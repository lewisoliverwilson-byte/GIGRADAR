...
export default function ArtistDetail({ initialArtist = null }) {
  ...
  const isClaimable = artist.isGrassroots && !artist.imageUrl && !artist.isTribute;
  const canClaim = !isClaimed && !claimDone && isClaimable;
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div className="min-w-0">
                <div className="flex items-center gap-2.5 flex-wrap mb-1">
                  ...
                  {artist.isTribute && (
                    <span className="text-xs font-black uppercase tracking-widest bg-zinc-800 text-zinc-400 px-2.5 py-1 border border-zinc-700">
                      Tribute Act
                    </span>
                  )}
                </div>
